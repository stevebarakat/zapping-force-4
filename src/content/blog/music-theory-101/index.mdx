...
<Callout type="instructions" title="Explore scales">
...
<Callout type="instructions" title="Explore rhythmic patterns">
...
<Callout type="instructions" title="Explore chords">
...
Upload a simple MIDI file or use one of our examples to see how the concepts we've discussed come together in actual music. The analyzer will identify key elements of the piece and show you how they relate to the music theory concepts we've explored.
...
<Callout type="exercise">
  This is an exercise callout with the default title.
</Callout>
...
<Callout type="success">
  This is a success callout with the default title.
</Callout>

<Callout type="definition">
  This is a definition callout with the default title.
</Callout>

<Callout type="tip">This is a tip callout with the default title.</Callout>

<Callout type="error">This is an error callout with the default title.</Callout>

<Callout type="info">
  This is an information callout with the default title.
</Callout>

<Callout type="instructions">
  This is an instructions callout with the default title.
</Callout>
